...
TAROT_CARDS = [
    {"id": "0", "name": "The Fool", "arcana": "major", "suit": None, "number": 0, "keywords": ["new beginnings", "innocence", "spontaneity", "free spirit"], "upright_meaning": "New beginnings, optimism, trust in life", "reversed_meaning": "Recklessness, taken advantage of, inconsideration"},
    {"id": "1", "name": "The Magician", "arcana": "major", "suit": None, "number": 1, "keywords": ["manifestation", "resourcefulness", "power", "inspired action"], "upright_meaning": "Manifestation, resourcefulness, power, inspired action", "reversed_meaning": "Manipulation, poor planning, untapped talents"},
    {"id": "2", "name": "The High Priestess", "arcana": "major", "suit": None, "number": 2, "keywords": ["intuition", "sacred knowledge", "divine feminine", "subconscious"], "upright_meaning": "Intuition, sacred knowledge, divine feminine, the subconscious mind", "reversed_meaning": "Secrets, disconnected from intuition, withdrawal"},
    {"id": "3", "name": "The Empress", "arcana": "major", "suit": None, "number": 3, "keywords": ["femininity", "beauty", "nature", "nurturing", "abundance"], "upright_meaning": "Femininity, beauty, nature, nurturing, abundance", "reversed_meaning": "Creative block, dependence on others"},
    {"id": "4", "name": "The Emperor", "arcana": "major", "suit": None, "number": 4, "keywords": ["authority", "establishment", "structure", "father figure"], "upright_meaning": "Authority, establishment, structure, a father figure", "reversed_meaning": "Domination, excessive control, lack of discipline"},
    {"id": "5", "name": "The Hierophant", "arcana": "major", "suit": None, "number": 5, "keywords": ["spiritual wisdom", "tradition", "conformity", "morality"], "upright_meaning": "Spiritual wisdom, religious beliefs, conformity, tradition", "reversed_meaning": "Personal beliefs, freedom, challenging the status quo"},
    {"id": "6", "name": "The Lovers", "arcana": "major", "suit": None, "number": 6, "keywords": ["love", "harmony", "relationships", "values alignment"], "upright_meaning": "Love, harmony, relationships, values alignment, choices", "reversed_meaning": "Self-love, disharmony, imbalance, misalignment of values"},
    {"id": "7", "name": "The Chariot", "arcana": "major", "suit": None, "number": 7, "keywords": ["control", "willpower", "determination", "direction"], "upright_meaning": "Control, willpower, success, action, determination", "reversed_meaning": "Self-discipline, opposition, lack of direction"},
    {"id": "8", "name": "Strength", "arcana": "major", "suit": None, "number": 8, "keywords": ["strength", "courage", "patience", "control", "compassion"], "upright_meaning": "Strength, courage, persuasion, influence, compassion", "reversed_meaning": "Inner strength, self-doubt, low energy, raw emotion"},
    {"id": "9", "name": "The Hermit", "arcana": "major", "suit": None, "number": 9, "keywords": ["soul searching", "introspection", "inner guidance", "solitude"], "upright_meaning": "Soul searching, introspection, being alone, inner guidance", "reversed_meaning": "Isolation, loneliness, withdrawal"},
    {"id": "10", "name": "Wheel of Fortune", "arcana": "major", "suit": None, "number": 10, "keywords": ["good luck", "karma", "life cycles", "destiny"], "upright_meaning": "Good luck, karma, life cycles, destiny, a turning point", "reversed_meaning": "Bad luck, resistance to change, breaking cycles"},
    {"id": "11", "name": "Justice", "arcana": "major", "suit": None, "number": 11, "keywords": ["justice", "fairness", "truth", "law", "accountability"], "upright_meaning": "Justice, fairness, truth, cause and effect, law", "reversed_meaning": "Unfairness, lack of accountability, dishonesty"},
    {"id": "12", "name": "The Hanged Man", "arcana": "major", "suit": None, "number": 12, "keywords": ["pause", "surrender", "letting go", "new perspectives"], "upright_meaning": "Pause, surrender, letting go, new perspectives", "reversed_meaning": "Delays, resistance, stalling, indecision"},
    {"id": "13", "name": "Death", "arcana": "major", "suit": None, "number": 13, "keywords": ["endings", "change", "transformation", "transition"], "upright_meaning": "Endings, change, transformation, transition", "reversed_meaning": "Resistance to change, personal transformation, inner purging"},
    {"id": "14", "name": "Temperance", "arcana": "major", "suit": None, "number": 14, "keywords": ["balance", "moderation", "patience", "purpose"], "upright_meaning": "Balance, moderation, patience, purpose", "reversed_meaning": "Imbalance, excess, self-healing, re-alignment"},
    {"id": "15", "name": "The Devil", "arcana": "major", "suit": None, "number": 15, "keywords": ["shadow self", "attachment", "addiction", "restriction"], "upright_meaning": "Shadow self, attachment, addiction, restriction, sexuality", "reversed_meaning": "Releasing limiting beliefs, exploring dark thoughts, detachment"},
    {"id": "16", "name": "The Tower", "arcana": "major", "suit": None, "number": 16, "keywords": ["sudden change", "upheaval", "chaos", "revelation"], "upright_meaning": "Sudden change, upheaval, chaos, revelation, awakening", "reversed_meaning": "Personal transformation, fear of change, averting disaster"},
    {"id": "17", "name": "The Star", "arcana": "major", "suit": None, "number": 17, "keywords": ["hope", "faith", "purpose", "renewal", "spirituality"], "upright_meaning": "Hope, faith, purpose, renewal, spirituality", "reversed_meaning": "Lack of faith, despair, self-trust, disconnection"},
    {"id": "18", "name": "The Moon", "arcana": "major", "suit": None, "number": 18, "keywords": ["illusion", "fear", "anxiety", "subconscious", "intuition"], "upright_meaning": "Illusion, fear, anxiety, subconscious, intuition", "reversed_meaning": "Release of fear, repressed emotion, inner confusion"},
    {"id": "19", "name": "The Sun", "arcana": "major", "suit": None, "number": 19, "keywords": ["positivity", "fun", "warmth", "success", "vitality"], "upright_meaning": "Positivity, fun, warmth, success, vitality", "reversed_meaning": "Inner child, feeling down, overly optimistic"},
    {"id": "20", "name": "Judgement", "arcana": "major", "suit": None, "number": 20, "keywords": ["judgement", "rebirth", "inner calling", "absolution"], "upright_meaning": "Judgement, rebirth, inner calling, absolution", "reversed_meaning": "Self-doubt, inner critic, ignoring the call"},
    {"id": "21", "name": "The World", "arcana": "major", "suit": None, "number": 21, "keywords": ["completion", "accomplishment", "travel", "fulfillment"], "upright_meaning": "Completion, accomplishment, travel, fulfillment", "reversed_meaning": "Seeking personal closure, short-cuts, delays"},
    ...
    {"id": "cups-ace", "name": "Ace of Cups", "arcana": "minor", "suit": "cups", "number": 1, "keywords": ["love", "new relationships", "compassion", "creativity"], "upright_meaning": "Love, new relationships, compassion, creativity", "reversed_meaning": "Self-love, intuition, repressed emotions"},
    {"id": "cups-2", "name": "Two of Cups", "arcana": "minor", "suit": "cups", "number": 2, "keywords": ["unified love", "partnership", "mutual attraction", "connection"], "upright_meaning": "Unified love, partnership, mutual attraction", "reversed_meaning": "Self-love, break-ups, disharmony, distrust"},
    {"id": "cups-3", "name": "Three of Cups", "arcana": "minor", "suit": "cups", "number": 3, "keywords": ["celebration", "friendship", "creativity", "community"], "upright_meaning": "Celebration, friendship, creativity, collaborations", "reversed_meaning": "Independence, alone time, hardcore partying, 'three's a crowd'"},
    {"id": "cups-4", "name": "Four of Cups", "arcana": "minor", "suit": "cups", "number": 4, "keywords": ["meditation", "contemplation", "apathy", "reevaluation"], "upright_meaning": "Meditation, contemplation, apathy, reevaluation", "reversed_meaning": "Retreat, withdrawn, checking in for alignment"},
    {"id": "cups-5", "name": "Five of Cups", "arcana": "minor", "suit": "cups", "number": 5, "keywords": ["regret", "failure", "disappointment", "pessimism"], "upright_meaning": "Regret, failure, disappointment, pessimism", "reversed_meaning": "Personal setbacks, self-forgiveness, moving on"},
    {"id": "cups-6", "name": "Six of Cups", "arcana": "minor", "suit": "cups", "number": 6, "keywords": ["revisiting the past", "childhood memories", "innocence", "joy"], "upright_meaning": "Revisiting the past, childhood memories, innocence, joy", "reversed_meaning": "Living in the past, forgiveness, lacking playfulness"},
    {"id": "cups-7", "name": "Seven of Cups", "arcana": "minor", "suit": "cups", "number": 7, "keywords": ["opportunities", "choices", "wishful thinking", "illusion"], "upright_meaning": "Opportunities, choices, wishful thinking, illusion", "reversed_meaning": "Alignment, personal values, overwhelmed by choices"},
    {"id": "cups-8", "name": "Eight of Cups", "arcana": "minor", "suit": "cups", "number": 8, "keywords": ["disappointment", "abandonment", "withdrawal", "escapism"], "upright_meaning": "Disappointment, abandonment, withdrawal, escapism", "reversed_meaning": "Trying one more time, indecision, aimless drifting"},
    {"id": "cups-9", "name": "Nine of Cups", "arcana": "minor", "suit": "cups", "number": 9, "keywords": ["contentment", "satisfaction", "gratitude", "wish come true"], "upright_meaning": "Contentment, satisfaction, gratitude, wish come true", "reversed_meaning": "Inner happiness, materialism, dissatisfaction"},
    {"id": "cups-10", "name": "Ten of Cups", "arcana": "minor", "suit": "cups", "number": 10, "keywords": ["divine love", "blissful relationships", "harmony", "alignment"], "upright_meaning": "Divine love, blissful relationships, harmony, alignment", "reversed_meaning": "Disconnection, misaligned values, struggling relationships"},
    {"id": "cups-page", "name": "Page of Cups", "arcana": "minor", "suit": "cups", "number": 11, "keywords": ["creative opportunities", "intuitive messages", "curiosity"], "upright_meaning": "Creative opportunities, intuitive messages, curiosity, possibility", "reversed_meaning": "New ideas, doubting intuition, creative blocks"},
    {"id": "cups-knight", "name": "Knight of Cups", "arcana": "minor", "suit": "cups", "number": 12, "keywords": ["creativity", "romance", "charm", "imagination"], "upright_meaning": "Creativity, romance, charm, imagination, beauty", "reversed_meaning": "Overactive imagination, unrealistic, jealous"},
    {"id": "cups-queen", "name": "Queen of Cups", "arcana": "minor", "suit": "cups", "number": 13, "keywords": ["compassionate", "caring", "emotionally stable", "intuitive"], "upright_meaning": "Compassionate, caring, emotionally stable, intuitive, in flow", "reversed_meaning": "Inner feelings, self-care, self-love, co-dependency"},
    {"id": "cups-king", "name": "King of Cups", "arcana": "minor", "suit": "cups", "number": 14, "keywords": ["emotionally balanced", "compassionate", "diplomatic"], "upright_meaning": "Emotionally balanced, compassionate, diplomatic", "reversed_meaning": "Self-compassion, inner feelings, moodiness"},
